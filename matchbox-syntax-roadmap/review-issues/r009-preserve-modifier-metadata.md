...
- [x] Class AST preserves `abstract` and `final`.
- [x] Function AST preserves `static`, `abstract`, and `final`.
- [x] Existing access modifier behavior still compiles.
- [x] C010 enforcement can be implemented without reparsing source text.
- [x] Tests assert modifier metadata in parser unit tests.
